...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <>
      ...
      <button className="block md:hidden p-4" aria-label="Open sidebar">
      ...
      {/* Sidebar for desktop */}
      <div className="hidden md:block w-64 bg-white/80 backdrop-blur-lg border-r border-gray-200 h-screen sticky top-0">
        <div className="p-6">
